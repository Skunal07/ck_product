                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?php if ($productCategory->status == 1) {
                                                            echo $this->Form->postLink(__('Deactivate'), ['controller' => 'Products', 'action' => 'productcstatus', $productCategory->id, $productCategory->status], ['confirm' => __('Are you sure you want to deactivate ?', $productCategory->id), 'class' => 'btn-btn-primary', 'escape' => false, 'title' => 'Deactive']);
                                                        } else {
